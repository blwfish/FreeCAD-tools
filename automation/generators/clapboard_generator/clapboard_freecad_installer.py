#!/usr/bin/env python3
"""
FreeCAD Macro Installer for clapboard_generator

Usage:
    python3 clapboard_freecad_installer.py          # standalone
...
def run():
    ...
    try:
        # Macro to root
        shutil.copy2(script_dir / "clapboard_generator.FCMacro",
                     macro_dir / "clapboard_generator.FCMacro")
        # Geometry library to _lib/
        shutil.copy2(script_dir / "clapboard_geometry.py",
                     lib_dir / "clapboard_geometry.py")
        ...
        print(f"✓ Clapboard generator v{GENERATOR_VERSION} installed")
        print(f"  Location: {macro_dir}")
        print(f"  Macro: clapboard_generator.FCMacro")
        print(f"  Library: _lib/clapboard_geometry.py")

...
# Version must match brick_generator_macro.FCMacro VERSION header
...
GENERATOR_SUBDIR = "automation/generators/brick_generator"
...
def populate_git_repo(verbose=False):
    ...
    try:
        ...
        print(f"  git commit -m 'Brick generator v{GENERATOR_VERSION}'")
